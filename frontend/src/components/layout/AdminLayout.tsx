  ...
  return (
    <AssistantProvider>
      <div className="flex min-h-screen bg-ink-100">
        {/* Mobile top bar */}
        <header className="fixed inset-x-0 top-0 z-40 flex h-14 items-center justify-between border-b border-ink-800 bg-ink-950 px-4 text-white md:hidden">
          <button
            type="button"
            className="inline-flex h-10 w-10 items-center justify-center rounded-lg text-ink-200 hover:bg-ink-800 hover:text-white"
          ...
          <Logo variant="mark" theme="dark" className="scale-90" />
          <NotificationBell />
        </header>
        ...
        <aside
          className={`fixed inset-y-0 left-0 z-50 flex w-[min(18rem,88vw)] flex-col border-r border-ink-800 bg-ink-950 text-white transition-transform duration-200 md:z-30 md:w-64 md:translate-x-0 ${
        ...
        <main className="min-w-0 flex-1 px-4 pb-8 pt-20 md:ml-64 md:px-8 md:pt-8">
          <Outlet />
        </main>

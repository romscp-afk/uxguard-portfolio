...
export default withApi(async (req, res) => {
  ...
  if (req.method === "POST") {
    ...
    try {
      const toEmail = body.toEmail || parent.email || parent.from_email;
      const toName = body.toName || parent.name || parent.from_name;
      const subject = body.subject || `Re: ${parent.subject}`;
